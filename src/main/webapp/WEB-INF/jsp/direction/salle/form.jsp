            ...
            <form action="save" method="post">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="numero" id="numero_in" class="form-control" placeholder="ex: Salle 1" required>
                    </div>


                    <div class="form-group">
                        <label for="capacite_in">Capacite:</label>
                        <input type="number" name="capacite" id="capacite_in" class="form-control" placeholder="ex: 20" required>
                    </div>
                </div>
